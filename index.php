  ...
  <div class="body"></div>
		...
		<div class="login">
			<form action="process.php" method="post">
				<input type="text" placeholder="File url that is blocked" name="url"><br>
				<input type="text" placeholder="your custom file name with Extension" name="file"><br>
				<input type="submit"  value="22Pass">
			</form>
		</div>
